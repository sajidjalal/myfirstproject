...
?>
                        ...
                        if ($this->module_lib->hasActive('sheet_view')) {
                            if (($this->rbac->hasPrivilege('sheet_view', 'can_view') )) {
                                ?>
                                <li class="treeview <?php echo set_Topmenu('sheet'); ?>">
                                    <a href="#">
                                        <i class="fa fa-credit-card"></i> <span>Sheet <?php echo $this->lang->line('sheet_view'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if ($this->rbac->hasPrivilege('sheet_view', 'can_view')) { ?>
                                            
                                            <li class="<?php echo set_Submenu('sheet/index'); ?>"><a href="<?php echo base_url(); ?>admin/sheet"><i class="fa fa-angle-double-right"></i> View Sheet<?php echo $this->lang->line('sheet_view'); ?></a></li>
                                           
                                        <?php } ?>
                                        <?php if ($this->rbac->hasPrivilege('sheet_view', 'can_view')) { ?>
                                            
                                            <li class="<?php echo set_Submenu('sheet/sheetsearch'); ?>"><a href="<?php echo base_url(); ?>admin/sheet/sheetsearch"><i class="fa fa-angle-double-right"></i> Serach Source<?php echo $this->lang->line('sheet_view'); ?></a></li>
                                           
                                        <?php } ?>
                                        <?php if ($this->rbac->hasPrivilege('sheet_view', 'can_view')) { ?>
                                            
                                            <li class="<?php echo set_Submenu('sheet/addIncomeHead'); ?>"><a href="<?php echo base_url(); ?>admin/sheet/addIncomeHead"><i class="fa fa-angle-double-right"></i> Add Income Source<?php echo $this->lang->line('sheet_view'); ?></a></li>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('marks_grade', 'can_view')) {
										 ...
										 <li class=""><a href="<?php echo base_url(); ?>admin/subjectassign"><i class="fa fa-angle-double-right"></i> Subject</a></li>
                                    </ul>
                                </li>
                                <?php
                            }

                            ...
                            if (!empty($examSchedule)) {
                                ...
                                <form role="form" id=""  class="addmarks-form"  method="post" action="<?php echo site_url('admin/mark/create') ?>">
                                    ...
                                    <input type="hidden" name="exam_id" value="<?php echo $exam_id; ?>">
                                     <input type = "hidden" name = "save_exam" value="save_exam">
                                                         ...
                                                         //   }
                                                            ...
                                                            <td>
                                                                <div class="form-group">
																	...
																	<input type = "hidden" name = "option<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value = "(<?php 
																		if(!empty($gradelist[$exam_schedule["subject_id"]])){	
																			echo $gradelist[$exam_schedule["subject_id"]];
																		}
																	?>)">
																	<small>(<?php 
																		if(!empty($gradelist[$exam_schedule["subject_id"]])){	
																	...
																	?>)</small>
                                                                    <input type="text" <?php echo $class; ?> name="student_number<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" class="form-control input-sm" id="subject_<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="<?php echo $exam_schedule['get_marks'] ?>" placeholder="Enter <?php 
																		if(!empty($gradelist[$exam_schedule["subject_id"]])){	
																			echo $gradelist[$exam_schedule["subject_id"]];
																		}
																	?>">
...
<script>
    ...
    $(function() {
        ...
        // $('input[id^="subject_"]').each(function () {
			// console.log($('select[name="'+$(this).attr('id').replace('subject_', 'option')+'"]').val())
			// if($('select[name="'+$(this).attr('id').replace('subject_', 'option')+'"]').val() == 'marks'){
				// $(this).rules('add', {
					// required: true,
					// messages: {
						// required: "Required"

                                    ...
                                    <select class = "form-control" name = "class">
										...
										<?php
											foreach($listclasses as $class){
												?>
												<option value = "<?php echo $class['id']; ?>" <?php if($class['id'] == $classsubject[0]['id']){ echo "selected"; } ?>><?php echo $class['class']; ?></option>
												<?php
											}
										?>
									</select>
                                ...
                                <div class="form-group">
									...
									<?php
										...
										foreach($listsubject as $subject){
											...
											<div class = "row">
												<div class = "col-md-7">
												<input type = "checkbox" name = "subject[]" value = "<?php echo $subject['id']; ?>" <?php if($subject['id'] == $classsubject[0]['subject'][$i]['id']){ echo "checked";} ?>/>
												<?php echo $subject['name']; ?></div>
												<div class = "col-md-5">
													<select class = "form-control" name = "markgrade[]">
														<option value = "">Select </option>
														<option value = "grade" <?php if($classsubject[0]['mark_grade'][$i] == 'grade'){ echo "selected"; } ?>>Grade</option>
														<option value = "mark" <?php if($classsubject[0]['mark_grade'][$i] == 'mark'){ echo "selected"; } ?>>Mark</option>
													</select>
												</div>
											</div>
											<?php

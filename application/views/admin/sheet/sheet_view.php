...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Sheet <?php echo $this->lang->line('sheet_view'); ?> <small><?php echo $this->lang->line('student_fee'); ?></small></h1>
    </section>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php //echo $title;      ?> Add Income<?php echo $this->lang->line('add_Income'); ?></h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo base_url() ?>admin/expense"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"> <?php echo $this->lang->line('income_head'); ?> <?php echo $this->lang->line('sajid'); ?></label> <small class="req">*</small>
            ...
            ?>">
                ...
                <div class="box box-primary">
                     <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Total Income</h3><br>
                        <h3 class="box-title titlefix">Total Expense</h3><br>
                        <h3 class="box-title titlefix">Total Remaing Balance</h3>
